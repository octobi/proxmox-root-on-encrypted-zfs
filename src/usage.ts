...
Usage, if you only have curl, unzip and sh:
         ...
         curl -fsSL https://raw.githubusercontent.com/octobi/proxmox-root-on-encrypted-zfs/main/src/cli.ts \\
         | sudo sh -s <command...>


Usage, if you have deno:

         sudo deno -A https://raw.githubusercontent.com/octobi/proxmox-root-on-encrypted-zfs/main/src/cli.ts <command...>


Usage, if you have deno, and have cloned this git repo:

         sudo deno -A ./src/cli.ts <command...>
